...
<html>
    <head>
        ...
        <body>
            <%-- Đọc cookie lưu đăng nhập --%>
            <%
                String usernameCookieSaved = "";
                String passwordCookieSaved = "";
                String rememberMeChecked = ""; // Trạng thái checked cho checkbox
                ...
                if (cookies != null) {
                    for (Cookie cookie : cookies) {
                        ...
                        if ("COOKIE_REMEMBER".equals(cookie.getName()) && "true".equals(cookie.getValue())) {
                            rememberMeChecked = "checked"; // Nếu có cookie thì checkbox được chọn
                        }
                    }
                }
            %>
            ...
            <div class="login-container">
                ...
                <form action="MainController" method="post">
                    ...
                    <div class="mb-3 text-start">
                        ...
                        <input name="Password" type="password" class="form-control" placeholder="Enter your password" value="<%= passwordCookieSaved%>" required>
                    </div>
                    <div class="form-check text-start">
                        <input class="form-check-input" type="checkbox" id="keep-signed-in" name="rememberMe" <%= rememberMeChecked%>>
